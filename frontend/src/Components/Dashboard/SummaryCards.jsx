  ...
  const cards = [
    {
      ...
      icon: TrendingUp,
      trend: totalIncome > 0 ? "This month" : "No data",
      trendUp: true,
    ...
    },
    {
      ...
      icon: TrendingDown,
      trend: totalExpenses > 0 ? "This month" : "No data",
      trendUp: false,
    ...
    },
    {
      ...
      icon: Wallet,
      trend: remainingBalance >= 0 ? "Available" : "Deficit",
    ...
    },
    {
      ...
      icon: Target,
      trend: activeGoals > 0 ? `${activeGoals} active` : "No goals",
      trendUp: activeGoals > 0,
